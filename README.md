...
**Even**，以开发者为中心，打造中国第一流的快速开发平台，全部开源，个人与企业可 100% 免费使用。

* 采用 [umi + antv + antd](https://gitee.com/kailong110120130/vue-element-plus-admin) 实现
* 改换 less，自动引入等功能
...
|     | 科室管理  | 配置系统组织机构（公司、科室、小组），树结构展现支持数据权限  |
|     | 职位管理  | 配置系统用户所属担任职务                    |
...
| 科室 & 职位  | ![科室管理](/.image/科室管理.jpg)   | ![职位管理](/.image/职位管理.jpg) | -                        |
